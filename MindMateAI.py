...
if "mindcoins" not in st.session_state:
    st.session_state.mindcoins = 0
if "streak" not in st.session_state:
    st.session_state.streak = 0
if "has_playlist_generator" not in st.session_state:
    st.session_state.has_playlist_generator = False
...
def render_dashboard():
    ...
    with col3:
        st.metric("🔥 Streak", f"{st.session_state.streak} challenges")
